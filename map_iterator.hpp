...
namespace ft
{
	...
	public:
		map_const_iterator(): it_(NULL) {};
		explicit	map_const_iterator( node_type* x ): it_(x) {};
		template <class Iter>
		map_const_iterator ( const map_iterator<Iter, node_type>& node_it ): it_(node_it.base()) {};

		node_type*	base() const							{ return (this->it_); };
		reference		operator* () const						{ return (this->it_->pair_data_); };
		map_const_iterator&	operator++()							{ this->it_ = successor(this->it_); return (*this); };			// pre-increment
		map_const_iterator	operator++(int)							{ map_const_iterator temp(*this); ++(*this); return (temp); };		// post-increment
		map_const_iterator&	operator--()							{ this->it_ = predecessor(this->it_); return (*this); };		// pre-decrement
		map_const_iterator	operator--(int)							{ map_const_iterator temp(*this); --(*this); return (temp); };		// post-decrement
		pointer			operator->() const						{ return (&(operator*())); };
		// reference		operator[]( difference_type n ) const	{ return (*(this->it_ + n)); };
	...
	template <class Tp, class Up, class node_type>
	bool operator==(const map_const_iterator<Tp, node_type>& x, const map_const_iterator<Up, node_type>& y)
		{ return (x.base() == y.base()); }
	template <class Tp, class Up, class node_type>
	bool operator!=(const map_const_iterator<Tp, node_type>& x, const map_const_iterator<Up, node_type>& y)
		{ return (x.base() != y.base()); }
